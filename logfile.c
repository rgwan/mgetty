#ident "$Id: logfile.c,v 1.44 1994/09/26 15:52:58 gert Exp $ Copyright (c) Gert Doering"
...
#if !defined(linux) && !defined(BSD) && !defined(SVR42) && !defined(solaris2)
...
extern int sys_nerr;
#if !defiend(__NetBSD__) && !defined( __FreeBSD__ )
